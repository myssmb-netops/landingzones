...
variable "fw_diags" {
  description = "(Required) Diagnostics settings for Azure Firewall"

}

variable "ip_diags" {
  description = "(Required) Diagnostics settings for Public IP"
  
}


variable "net_diags" {
  description = "(Required) Diagnostics settings for Virtual network"
